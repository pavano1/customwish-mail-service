...
export const reviewEvent = async (data, callback) => {
  const maillist = [
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Event Review-Email:${data?.email}`,
      html: `
...
<html lang="en">
  ...
  Have any suggestions, feedback that you want to share with us?
</p>
<p style="margin: 0; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
  We would love to hear, share your response with us.
</p>
          ...
          <td style="padding: 30px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 16px; color: #333;">
              <tr>
                ...
                <td style="padding: 10px 0;">${data?.product_id}</td>
              </tr>
<tr>
               ...
               <tr>
                <td style="padding: 10px 0; font-weight: bold;">Rating</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.rating}</td>
              </tr>
<tr>
                <td style="padding: 10px 0; font-weight: bold;">Comment</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.review}</td>
              </tr>
            </table>
          </td>
        </tr>
