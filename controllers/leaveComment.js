...
export const leaveComment = async (data, callback) => {
  const maillist = ["kiran.s@thecustomwish.com"];
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Leave a Comment-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
             Have any suggestions, feedback that you want to share with us? We would love to hear, share your response with us.
               </p>
        ...
        <tr>
          <td style="padding: 30px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 16px; color: #333;">
              <tr>
                <td style="padding: 10px 0; font-weight: bold;">Blog Name</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.blog_name}</td>
              </tr>
<tr>
               ...
               <tr>
                ...
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.website}</td>
              </tr>
               <tr>
                <td style="padding: 10px 0; font-weight: bold;">Comment</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.comment}</td>
              </tr>
            </table>
          </td>
        </tr>
