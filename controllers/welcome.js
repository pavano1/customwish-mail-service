...
export const welcome = async (data, callback) => {
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `Welcome to CustomWish! ${data?.email} Enjoy 10% Off`,
      html: `
...
<html lang="en">
  ...
  <body style="margin: 0; font-family: 'Poppins', sans-serif; background: #ffffff; font-size: 14px;">
    <div style="width: 100%;max-width: 680px; margin: 0 auto; padding: 45px 30px 60px; background: #f9a974; background-image: url(https://thecustomwish.com/public/uploads/images/3.jpg); background-repeat: repeat; background-size: 800px 452px; background-position: top center; font-size: 14px; color: #4342D9;">
      <header>
      ...
      <main>
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <h1 style="margin: 0; font-size: 18px; font-weight: 800; color: #2a2462;">
              Welcome to CustomWish Family!
            </h1>

            <p style="margin: 0; margin-top: 20px; font-size: 20px; font-weight: 500; color: #c0352f;">
              Dear ${data?.name},
            </p>


           <p style="margin: 0; margin-top: 20px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size:15px;">
  Yippee! You are in!
</p>
<p style="margin: 0;margin-top: 10px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size:15px;">
  Thanks for signing up.
</p>
<p style="margin: 0;margin-top: 10px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size:15px;">
  Say hello to all new exclusive collections of gifts and offers. Together let's make the celebration great. We promise to keep you up-to-date with the sweetest new-season items.
</p>
<p style="margin: 0;margin-top: 10px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size:15px;">
  We've decided to give you a small bit of affection as a special WELCOME present - <span style="color:#ce1219;font-weight:500;">10% OFF</span> on your first online order. <span style="color:#ce1219;font-weight:600;">USE CODE: WELCOME10</span>
</p>
<p style="margin: 0;margin-top: 10px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size:15px;">
  You will be among the first to receive all of our exclusive offers, the most recent updates, and announcements. Hurry!!! Discover our interesting products now!
</p>
<p style="margin: 0;margin-top: 10px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size:15px;">
  Also we will keep in mind not to bombard you with our marketing emails!
</p>
<p style="margin: 0;margin-top: 10px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size:15px;">
  So start shopping! We’re excited to start sharing our best deals with you.
</p>
