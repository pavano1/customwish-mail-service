...
export const returnOrder = async (data, callback) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Return Order-Email:${data?.email}`,
      html: `
...
<p style="margin: 0; margin-top: 8px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left">
             Are you sure you want to do it or wait a minute have you changed your mind?
            </p>
<p style="margin: 0; margin-top: 8px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left">
             Write below if we can do anything for you or click to proceed to return the order.
            </p>
...
<html lang="en">
  ...
  <tr>
    <td style="padding: 15px; text-align: center; background-color: #002a5c; color: #ffffff; font-size: 18px; font-weight: bold; word-break: break-word;">
    ...
    <td style="padding: 20px;">
      <table cellpadding="0" cellspacing="0" style="font-size: 14px; color: #333; width: 100%;">
        <tr>
          ...
          <td style="padding: 8px 0;">${data?.order_number}</td>
        </tr>
        <tr>
          <td style="padding: 8px 0; font-weight: bold;">Product Name</td>
          <td style="padding: 8px 0;">:&nbsp;</td>
          <td style="padding: 8px 0;">${data?.product_name}</td>
        </tr>
        <tr>
  ...
  <tr>
    <td style="text-align: center; padding: 15px; background-color: #f0f0f0; color: #888; font-size: 13px;">
