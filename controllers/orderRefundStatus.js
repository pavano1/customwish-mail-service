...
export const orderRefundStatus = async (data, callback) => {
  ...
  try {
    ...
    if (data?.orderStatus === "refunded") {
      await transporter.sendMail({
          ...
          to: data?.email,
          subject: `CustomWish Refund-Email:${data?.email}`,
          html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
             <p>You have received a refund of INR - ${data?.price} from https://thecustomwish.com/ back in your account.</p>
                                    <p>Here are the refund details:</p>
                                    <p>Merchant Order ID- ${data?.razorpay_order_id}</p>
                                    <p>Merchant Receipt ID- ${data?.razorpay_receipt_id}</p>
                                    <p>Your order no. is - ${data?.generateorderid}</p>
                                    <p>Placed on - ${data?.placedOn}</p>
               </p>
...
<html lang="en">
      ...
      <main>
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
            <p>Hurray! </p>
                                    <p>Your order has been ${data?.orderStatus}.</p>
  ...
  Ashirwad No.U-11, 1st cross, Pipeline, Malleshwaram, Bangalore-560003
    ...
    await transporter.sendMail({
      from: "contact@thecustomwish.com",
      to: maillist,
      subject: `CustomWish Refunded-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
             <p><strong>Order Information:</strong></p>
                    <p>
                    <a href="https://thecustomwish.com/mail/${data?.generateorderid}">Click here for invoice and Product details</a></p>
               </p>
