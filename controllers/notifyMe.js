...
export const notifyMe = async (data, callback) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Notify Me-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
             Oops! With a heavy heart, We apologize! Unfortunately, we do not have the product you ordered in stock.But hey, do not forget to check out our other similar collections. Keep browsing.
               </p>
