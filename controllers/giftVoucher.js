...
export const giftVoucher = async (data, callback) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Gift Voucher-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
             Greetings of the day!We appreciate your shopping with us for the amount of Rs.${data?.giftcard_price} which is why we want to send you a lovely thank you note and a gift voucher of Rs.${data?.giftcard_price}.
This gift voucher is valid for 1 year so your loved ones can use them when it's convenient for them. Simply visit our website -www.thecustomwish.com and explore our range of products.
The redemption of the voucher is simple. Just present it at the point of purchase, and the amount will be deducted from the total by applying the coupon code
Shop for Rs.${data?.giftcard_price} and don’t forget you can also personalize your gift voucher with a personal note to make it one-of-a-kind and heartful. So shop now, Get now!
</p>
<p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
Use Code- ${data?.generated_code}
</p>
<p>From- ${data?.from_name}</p>
        ...
        <tr>
          <td style="padding: 30px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 16px; color: #333;">
              <tr>
                <td style="padding: 10px 0; font-weight: bold;">GiftCard Price</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.giftcard_price}</td>
              </tr>
<tr>
                <td style="padding: 10px 0; font-weight: bold;">GiftCard Code</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.generated_code}</td>
              </tr>
                <tr>
                <td style="padding: 10px 0; font-weight: bold;">To Email</td>
                <td style="padding: 10px 0;">:</td>
               ...
               <tr>
                ...
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.from_name}</td>
              </tr>
               <tr>
                <td style="padding: 10px 0; font-weight: bold;">Message</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.messages}</td>
              </tr>
            </table>
          </td>
        </tr>
