...
export const enquiry = async (data, callback) => {
  const maillist = ["queries@thecustomwish.com", "kiran.s@thecustomwish.com"];
  try {
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "queries@thecustomwish.com",
        pass: "grby orsl qlei dyvr",
    ...
    await transporter.sendMail({
      from: "queries@thecustomwish.com",
      to: data?.email,
      subject: `CustomWish Enquiry-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
             Thank You for your enquiry.In response to your enquiry, we will get back to you with the relevant information at the earliest.
            </p>
