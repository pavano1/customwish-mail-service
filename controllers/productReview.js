...
export const productReview = async (data, callback) => {
  const maillist = ["reviews@thecustomwish.com", "kiran.s@thecustomwish.com"];
  try {
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "reviews@thecustomwish.com",
        pass: "ipok mckb cgto onhr",
    ...
    await transporter.sendMail({
      from: "reviews@thecustomwish.com",
      to: data?.email,
      subject: `CustomWish Product Review-Email:${data?.email}`,
      html: `
...
<html lang="en">
  ...
  Have any suggestions or feedback that you want to share with us?
</p>
<p style="margin: 0; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
  We would love to hear it — share your response with us.
</p>
