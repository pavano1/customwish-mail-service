...
export const verifyOTP = async (data, callback) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Verify OTP-Email:${data?.email}`,
      html: `
...
<html lang="en">
      ...
      <main>
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-size: 20px; font-weight: 500; color: #c0352f;">
              Hey ${data?.name},
            </p>

            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;text-align:left;font-size: 15px;">
              Thank you for choosing Customwish. Use the following OTP
              to complete the procedure to verify your email address. OTP is
              valid for <span style="font-weight: 900; font-size: 18px; color: #c0352f;">20 minutes</span>.
  ...
  Ashirwad No.U-11, 1st cross, Pipeline, Malleshwaram, Bangalore-560003
    ...
    await transporter.sendMail({
      from: "contact@thecustomwish.com",
      to: maillist,
      subject: `New User Registered -Email:${data?.email}`,
      html: `
...
<html lang="en">
  ...
  <body style="margin: 0; font-family: 'Poppins', sans-serif; background: #ffffff; font-size: 14px;">
    <div style="width: 100%;max-width: 680px; margin: 0 auto; padding: 45px 15px 60px; background: #f9a974; background-image: url(https://thecustomwish.com/public/uploads/images/3.jpg); background-repeat: repeat; background-size: 800px 452px; background-position: top center; font-size: 14px; color: #4342D9;">
      <header>
        <div style="margin: 0; margin-top: 16px; text-align: center;">
          <a href="http://www.facebook.com/thecustomwish" target="_blank" style="display: inline-block;" title="facebook">
             <img width="32" height="32" alt="Facebook" src="https://thecustomwish.com/public/img/facebook.png" />
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;"> </p>
              ...
              <table cellpadding="0" cellspacing="0" style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 20px;width: 100%;">
  <tr>
    <td align="center">
      <table cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1);width: 100%; max-width: 100%;">
        <tr>
        ...
        <tr>
          <td style="padding: 30px;">
            <table cellpadding="0" cellspacing="0" style="font-size: 16px; color: #333;width: 100%;">
              <tr>
