...
export const career = async (data, callback) => {
  const maillist = ["career@thecustomwish.com", "kiran.s@thecustomwish.com"];
  try {
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "career@thecustomwish.com",
        pass: "azhz fpyd nuxl qlkh",
    ...
    await transporter.sendMail({
      from: "career@thecustomwish.com",
      to: data?.email,
      subject: `CustomWish Career-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
              Are you awesome? Come Join our Team! So if you are looking for a change and are brilliant at what you do, then come let’s rock together.
               Fill out the form and our executive will reach out to you within the next business day.
            </p>
...
<tr>
                <td style="padding: 10px 0; font-weight: bold;">Resume</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;"><a href="https://thecustomwish.com/public/uploads/pdf/${data?.profileresume}" download>Click here to download the resume</a></td>
              </tr>
<tr>
