...
export const enquiryEvent = async (data, callback) => {
  const maillist = [
    "customwisheventplanner@thecustomwish.com",
  ...
  try {
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "customwisheventplanner@thecustomwish.com",
        pass: "oogy vrfc dxiv ukur",
    ...
    await transporter.sendMail({
      from: "customwisheventplanner@thecustomwish.com",
      to: data?.email,
      subject: `CustomWish Event Equiry-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <h1 style="margin: 0; font-size: 24px; font-weight: 800; color: #2a2462;">
              Welcome to CustomWish Event Planner
            </h1>
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
             Have an event coming up? Connect with us and you we will bring together a fantabulous and grandeur event for you. Connect with our team to see the glimpse of our work.
            </p>
        ...
        <tr>
          <td style="padding: 30px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 16px; color: #333;">
              <tr>
                <td style="padding: 10px 0; font-weight: bold;">Product Name</td>
