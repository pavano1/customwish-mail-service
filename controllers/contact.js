...
export const contact = async (data, callback) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Contact Us-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
              We aren’t going to spam you thousands of times. Thank you for submitting the form. We will reach you within 24 hours.
            </p>
...
<html lang="en">
  ...
  <tr>
    <td align="center">
      <table cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1); width: 100%; max-width: 100%; font-family: Arial, sans-serif;">
  <tr>
    ...
    <td style="padding: 20px;">
      <table cellpadding="0" cellspacing="0" style="font-size: 14px; color: #333; width: 100%;">
        ...
        <tr>
          ...
          <td style="padding: 8px 0;">:&nbsp;</td>
          <td style="padding: 8px 0;word-break: break-word;">${data?.message}</td>
        </tr>
      </table>
    </td>
  </tr>
