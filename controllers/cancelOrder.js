...
export const cancelOrder = async (data, callback) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      to: data?.email,
      subject: `CustomWish Cancel Order-Email:${data?.email}`,
      html: `
        ...
        <div style="margin: 0; margin-top: 30px; padding: 50px 30px 115px; background: #ffffff; border-radius: 30px; text-align: center;">
          ...
          <div style="width: 100%; max-width: 489px; margin: 0 auto; padding-top: 60px;">
            ...
            <p style="margin: 0; margin-top: 17px; font-weight: 500; letter-spacing: 0.56px; color: #2a2462;">
              We are sorry to see you leave.Is there anything that we can do to make you stay? We are always here to help !
            </p>
          ...
          <td style="padding: 30px;">
            <table width="100%" cellpadding="0" cellspacing="0" style="font-size: 16px; color: #333;">
              <tr>
                ...
                <td style="padding: 10px 0;">${data?.product_name}</td>
              </tr>
              <tr>
                <td style="padding: 10px 0; font-weight: bold;">Order Id</td>
                <td style="padding: 10px 0;">:</td>
                <td style="padding: 10px 0;">${data?.order_number}</td>
              </tr>
                <tr>
